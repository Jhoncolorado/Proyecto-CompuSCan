  ...
  return (
    <div className="devices-bg">
      <div className="devices-panel">
        {isMobile ? (
          <>
            <div className="devices-title-container">
              <h1 className="devices-title devices-title-mobile">Gestión de Dispositivos</h1>
            </div>
            ...
            {showRegistrationForm ? (
              ...
              <div className="devices-cards-mobile">
                {loading ? (
                  ...
                  filteredDevices.map(device => (
                    <div className="device-card-mobile" key={device.id}>
                      <div className="device-card-row">
                        <span className="device-card-label">Foto</span>
                        <div>
                      ...
                      <div className="device-card-row"><span className="device-card-label">Nombre</span> {device.nombre}</div>
                      <div className="device-card-row"><span className="device-card-label">Tipo</span> {device.tipo}</div>
                      <div className="device-card-row"><span className="device-card-label">Serial</span> {device.serial}</div>
                      <div className="device-card-row"><span className="device-card-label">Usuario</span> {device.nombre_usuario}</div>
                      <div className="device-card-row"><span className="device-card-label">RFID</span> {device.rfid || <span className="device-norfid">No asignado</span>}</div>
                      <div className="device-card-row"><span className="device-card-label">Estado</span> {estadoBadge(device.estado_validacion || 'pendiente')}</div>
                      <div className="device-card-row"><span className="device-card-label">Fecha Registro</span> {device.fecha_registro ? new Date(device.fecha_registro).toLocaleDateString() : ''}</div>
                    </div>
                  ))
                )}
              </div>
